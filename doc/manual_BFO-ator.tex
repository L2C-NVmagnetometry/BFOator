...
\begin{wrapfigure}[24]{l}{7.5cm}
  ...
  \begin{tikzpicture}[tdplot_main_coords]
     \def\c{2.7}
         ...
         \draw[orange, line width=2pt, stealth-stealth](0, 0, 1)--++(0.5*\c, 0.29*\c, 0.81*\c) node[fill=white, fill opacity= 0.7,inner sep=0.5pt, node font=\large, below right=3mm and 1mm]{$\vec{k}_3$};
         \draw[gray!70, line width=3pt, -Triangle] (0*\c, 0.3*\c, 0.2*\c)--++(0, -1.09*\c, 0.39*\c)node[gray, node font=\large, above=0mm, fill=white, fill opacity= 0.7,inner sep=0.5pt]{$\vec{P} [11\bar{1}]$};
          \draw[red, line width=2pt, stealth-stealth](\c, 0, 1)--++(-0.5*\c, 0.29*\c, 0.81*\c) node[node font=\large, below left=2mm and 5mm, fill=white, fill opacity= 0.7,inner sep=0.5pt]{$\vec{k}_2$};
       
       
        \begin{scope}[xshift=2.8cm, yshift=-0.75cm]
          \draw[-stealth] (0, 0, 0)--(0, 0, 1)node[right]{$z$};
          \draw[-stealth] (0, 0, 0)--(1, 0, 0)node[below]{$x$};
          \draw[-stealth] (0, 0, 0)--(0, 1, 0)node[below]{$y$};
        \end{scope}
